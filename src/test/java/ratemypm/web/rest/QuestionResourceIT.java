...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().questionText(DEFAULT_QUESTION_TEXT);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().questionText(UPDATED_QUESTION_TEXT);
        return question;
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        updatedQuestion.questionText(UPDATED_QUESTION_TEXT);
